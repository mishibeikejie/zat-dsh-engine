...
`;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					showLegend && (selfUpdate && selfUpdate.changes && selfUpdate.changes.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						}), selfUpdate.changes.map((c) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							className: "zat-lgi",
							children: ["· ", c]
						}, c))]
					}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		function SessionManagerPanel({ pm, locale }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					sessions !== null && sessions.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "zat-status",
						children: t("没有会话", "No sessions")
					}),
					sessions !== null && sessions.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "zat-detail",
						children: sessions.map((it) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "zat-srow",
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: "zat-smeta",
								children: [
									...
									it.archived && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "zat-tag",
										children: t("已归档", "Archived")
									})
								]
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								className: "zat-btn zat-danger",
