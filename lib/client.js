...
`;
		...
		function MarketCard({ item, zh, t, installing, onOpen, onAction }) {
			...
			const btnText = installing ? t("处理中…", "...") : item.isHarness ? zh ? "✓ 使用中" : "✓ In use" : item.disabled ? zh ? "已装·未启用" : "Installed, disabled" : hasUpdate ? t("更新", "Update") : item.installed ? t("已安装", "Installed") : t("安装", "Install");
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "zat-card",
				onClick: () => onOpen(item),
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
