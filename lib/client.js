...
`;
		...
		function MarketCard({ item, zh, t, installing, onOpen, onAction, onStar }) {
			...
			const btnText = installing ? t("处理中…", "...") : item.isHarness ? zh ? "✓ 使用中" : "✓ In use" : item.disabled ? zh ? "已装·未启用 → 点此启用" : "Installed, disabled → click to enable" : nonInstallable ? item.kind === "skill" ? zh ? "技能 · 不可安装" : "Skill · not installable" : zh ? "非插件 · 不可安装" : "Not a plugin" : hasUpdate ? t("更新", "Update") : item.installed ? t("已安装", "Installed") : t("安装", "Install");
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "zat-card",
				onClick: () => onOpen(item),
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
