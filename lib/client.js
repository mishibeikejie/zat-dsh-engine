...
`;
		...
		function MarketPanel({ pm, locale }) {
			...
			function requestVersions(list) {
				...
				pm.versions().then((vr) => {
					if (vr.ok && vr.value.ok && vr.value.map) setItems((prev) => prev ? prev.map((it) => vr.value.map[it.fullName] ? {
						...it,
			...
			if (detail) {
				...
				const mainBtn = !detail.installed && !dd?.isMonorepo ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							dd?.isMonorepo && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: "zat-monobadge",
								children: t("⚠ 这是多插件仓库(根目录无 package.json),无法一键安装,请到 GitHub 查看各子插件的安装方式", "⚠ Multi-plugin repo (no root package.json); open GitHub for per-plugin install steps")
							}),
							...
							dd ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								}), (dd.summary || t("该仓库暂无 README 摘要", "No README summary")).slice(0, 1200)]
							}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									mainBtn,
									detail.installed && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					subChoices && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: t("这是多插件仓库,请选择要安装的子插件:", "Multi-plugin repository — choose a sub-package to install:")
							}),
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						}) : item.installed ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							className: "zat-badge",
							children: ["✓ ", t("已安装", "Installed")]
						}) : null,
