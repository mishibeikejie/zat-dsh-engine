...
`;
		...
		function MarketCard({ item, zh, t, installing, onOpen, onAction }) {
			...
			const btnClass = nonInstallable ? item.kind === "skill" ? "zat-noninstall" : "zat-nonplugin" : hasUpdate ? "zat-update" : item.installed ? "zat-installed" : "zat-install";
