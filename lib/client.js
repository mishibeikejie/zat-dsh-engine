...
`;
		...
		function MarketPanel({ pm, locale }) {
			...
			function onStar(item) {
				pm.star(item.owner, item.name).then((res) => {
					...
					if (res.ok && value && value.ok && typeof value.starred === "boolean") {
						...
						const u = String(value.url || item.htmlUrl || `https://github.com/${item.fullName}`);
			...
			function doInstall(item) {
				...
				pm.installPlugin(item.owner, item.name, "").then((res) => {
					...
					if (res.ok && value?.ok) refreshItem(item.fullName, {
						installed: true,
			...
			if (detail) {
				...
				const mainBtn = detail.isHarness || Boolean(dd && dd.notPlugin) ? null : !detail.installed ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									detail.installed && detail.installedVersion && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							detail.disabled && !detail.isHarness && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "zat-subchoices-title",
									children: [t("这个插件已安装,但不在启用列表里——重启 dsh 也不会加载。", "This plugin is installed but missing from the bundle list — it will not load even after a restart."), " " + t("重新点一次安装通常能修复;或手动运行 dsh plugin 命令启用。", "Installing again usually fixes it, or enable it with the dsh plugin command.")]
								})
							}),
							...
							dd ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: "zat-summary",
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "zat-zhlabel",
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									mainBtn,
									detail.installed && !detail.isHarness && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							selfUpdate && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
								...
								onClick: () => {
									pm.selfupdate(true).then((r) => {
										setNotice(r.ok ? String(r.value.message || "") : r.error.message);
										if (r.ok && r.value.ok) setSelfUpdate(null);
									}).catch((err) => setNotice(String(err?.message || err)));
								},
								children: [
									"↑ ",
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
								className: "zat-sel",
								value: instFilter,
								onChange: (e) => setInstFilter(e.currentTarget.value),
					...
					showLegend && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: "zat-lgi",
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { style: { background: "#f0a94b" } }), t("已装·未启用", "Installed, disabled")]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: "zat-lgi",
								children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						}), page * 100 < total && !loading && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							className: "zat-btn",
		...
		function MarketCard({ item, zh, t, installing, onOpen, onAction, onStar }) {
			...
			const btnText = installing ? t("处理中…", "...") : item.isHarness ? zh ? "✓ 使用中" : "✓ In use" : item.disabled ? zh ? "已装·未启用" : "Installed, disabled" : nonInstallable ? item.kind === "skill" ? zh ? "技能 · 不可安装" : "Skill · not installable" : zh ? "非插件 · 不可安装" : "Not a plugin" : hasUpdate ? t("更新", "Update") : item.installed ? t("已安装", "Installed") : t("安装", "Install");
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "zat-card",
				onClick: () => onOpen(item),
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "zat-cover",
					children: [
						coverErr ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
