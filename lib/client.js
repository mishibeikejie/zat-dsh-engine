...
`;
		...
		function MarketPanel({ pm, locale }) {
			...
			const seedRetryRef = (0, react.useRef)(0);
			const listElRef = (0, react.useRef)(null);
			const listScrollRef = (0, react.useRef)(0);
			...
			(0, react.useEffect)(() => {
				if (!notice) return;
				const timer = setTimeout(() => setNotice(""), 9e3);
				return () => clearTimeout(timer);
			}, [notice]);
			(0, react.useEffect)(() => {
				return injectCss();
			}, []);
			function load(p, s, q, cat, append, background = false) {
				...
				const listTimeout = new Promise((_, reject) => {
					timer = setTimeout(() => reject(new Error(t("加载超时,请重试(网络慢)", "Load timed out — retry (slow network)"))), 25e3);
				});
				Promise.race([pm.list(p, s, q, cat), listTimeout]).then((res) => {
					...
					if (data.hasMore && p < 10 && token === loadTokenRef.current) {
						const t = token;
						setTimeout(() => {
							if (t === loadTokenRef.current) load(p + 1, s, q, cat, true, true);
						}, 120);
					}
					if (data.source === "seed" && p === 1 && token === loadTokenRef.current) {
						...
						if (attempts <= 3) {
							const t = token;
							setTimeout(() => {
								if (t === loadTokenRef.current) load(p, s, q, cat, true, true);
							}, 8e3);
						}
					}
				}).catch((err) => {
			...
			(0, react.useEffect)(() => {
				...
				let retryTimer = null;
				const checkSelfUpdate = () => {
					pm.selfupdate(false, zh).then((r) => {
						if (r.ok && r.value.ok) {
							if (retryTimer) {
								clearTimeout(retryTimer);
								retryTimer = null;
							}
							if (r.value.hasUpdate) setSelfUpdate({
								hasUpdate: true,
								...
								setSelfUpdate({
									checkFailed: true,
									checkError: r.value.message || ""
								});
								retryTimer = setTimeout(checkSelfUpdate, 1e4);
							} else setSelfUpdate({
								hasUpdate: false,
								latestVersion: r.value.latestVersion || void 0
							});
						} else {
							setSelfUpdate({
								checkFailed: true,
								checkError: !r.ok ? String(r.error?.message || "RPC failed") : String(r.value?.message || "")
							});
							retryTimer = setTimeout(checkSelfUpdate, 1e4);
						}
					}).catch(() => {
				...
				checkSelfUpdate();
				const updateTimer = setInterval(checkSelfUpdate, 45e3);
				const onVisible = () => {
					if (typeof document !== "undefined" && document.visibilityState === "visible") checkSelfUpdate();
				};
				...
				pm.installed().then((r) => {
					if (r.ok && r.value.ok) setProfileInfo({
						...
						marketVersion: String(r.value.marketVersion || "")
					});
				}).catch(() => {});
			...
			*/
			...
			if (detail) {
				...
				const mainBtn = detail.isHarness || detail.kind === "nonplugin" ? null : !detail.installed && !detail.disabled ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					className: "zat-btn zat-primary",
					onClick: () => doInstall(detail),
					disabled: !!installing,
					children: installing ? t("安装中…", "Installing…") : detail.kind === "skill" ? t("安装技能", "Install skill") : t("安装插件", "Install")
					...
					disabled: true,
					children: ["✓ ", detail.noRepo || detail.kind === "skill" ? t("已安装", "Installed") : t("已是最新", "Up to date")]
				}) : null;
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								detail.noRepo && !detail.isHarness && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								detail.isHarness && detail.noRepo && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "zat-summary",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "zat-zhlabel",
										children: t("系统组件:", "System component:")
								...
								detail.kind === "skill" && !detail.installed && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "zat-summary",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "zat-zhlabel",
										children: t("技能(skill):", "Skill:")
								...
								detail.kind === "nonplugin" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "zat-summary",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "zat-zhlabel",
										children: t("不可安装:", "Not installable:")
								...
								detail.kind === "unknown" && Boolean(dd && dd.notPlugin) && !detail.installed && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "zat-summary",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "zat-zhlabel",
										children: t("待识别:", "Unclassified:")
								...
								!detail.noRepo && (dd ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: detailFailed ? t("README 加载失败(网络不可用),可直接去 GitHub 查看", "README failed to load (network) — view it on GitHub") : t("正在读取 README 简介…", "Loading README…")
								})),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										(detail.installed || detail.disabled) && !detail.isHarness && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											...
											disabled: !!installing,
											children: detail.kind === "skill" ? t("卸载技能", "Uninstall skill") : t("卸载插件", "Uninstall")
										}),
				...
				children: [
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [
									...
									profileInfo && profileInfo.marketVersion ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("small", {
										className: "zat-ver",
										title: t("市场当前版本", "Market current version"),
										children: ["v", profileInfo.marketVersion]
									}) : null,
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: total ? `${t("共 ", "")}${total}${t(" 个", "")}` : "" })
								]
							}),
							selfUpdate && selfUpdate.checkFailed && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: "zat-status",
								title: selfUpdate.checkError ? t("更新检查出错:", "Update check error:") + selfUpdate.checkError : t("连不上 GitHub,更新检查失败", "Cannot reach GitHub, update check failed"),
								children: ["⚠ ", selfUpdate.checkError ? t("更新检查出错,稍后重试", "Update check error, retry later") : t("检查更新失败(网络),稍后重试", "Update check failed (network), retry later")]
							}),
							selfUpdate && selfUpdate.hasUpdate && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					showLegend && (selfUpdate && selfUpdate.changes && selfUpdate.changes.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: "zat-lgi",
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { style: { background: "#d97706" } }), t("技能·可安装", "Skill · installable")]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: "zat-lgi",
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							children: [
								...
								instFilter !== "all" ? `${t("已显示 ", "Showing ")}${filtered.length} / ${total}` : `${t("已加载 ", "Loaded ")}${items ? items.length : 0} / ${total}`,
								t(" · GitHub 搜索上限 1000", " · GitHub cap 1000")
							]
						})
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		function MarketCard({ item, zh, t, installing, progress, taskProgress, onOpen, onAction, onStar, onToggle }) {
			...
			const btnClass = item.disabled ? "zat-disabled" : nonInstallable ? "zat-nonplugin" : hasUpdate ? "zat-update" : item.installed ? "zat-installed" : "zat-install";
			const btnText = busy ? t("处理中…", "...") : item.isHarness ? zh ? "✓ 使用中" : "✓ In use" : item.disabled ? zh ? "已装·未启用 → 点此启用" : "Installed, disabled → click to enable" : nonInstallable ? zh ? "非插件 · 不可安装" : "Not a plugin" : hasUpdate ? t("更新", "Update") : item.installed ? t("已安装", "Installed") : t("安装", "Install");
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "zat-card",
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						item.kind === "client" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "zat-kindbadge zat-kind-client",
							children: zh ? "主题/UI" : "Theme/UI"
						}),
