	...
	return class ZatMarketGateway extends _classSuper {
		...
		*/
		...
		async resolvePnpmCommand() {
			...
			cands.push(join(process.env.TEMP || "", "zat-tools", "pnpm.cjs"), join(process.env.TEMP || "", "zat-tools", "pnpm.exe"), join(process.env.LOCALAPPDATA || "", "pnpm", "pnpm.exe"), join(process.env.LOCALAPPDATA || "", "pnpm", "pnpm.cmd"), join(process.env.APPDATA || "", "npm", "pnpm.cmd"), join(process.env.ProgramFiles || "", "nodejs", "pnpm.cmd"));
		...
		*/
		...
		async pnpmAvailable() {
			...
			const cands = [];
			if (process.env.PNPM_MJS) cands.push(process.env.PNPM_MJS);
			cands.push(join(process.env.TEMP || "", "zat-tools", "pnpm.cjs"), join(process.env.TEMP || "", "zat-tools", "pnpm.exe"), join(process.env.APPDATA || "", "npm", "pnpm.cmd"), join(process.env.LOCALAPPDATA || "", "pnpm", "pnpm.cmd"), join(process.env.ProgramFiles || "", "nodejs", "pnpm.cmd"));
